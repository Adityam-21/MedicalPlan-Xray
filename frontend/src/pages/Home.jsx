...
function Stat({ label, value, hint }) {
    return (
        <div className="px-5 py-4">
            ...
            <p className="mt-1 font-mono text-2xl font-medium tabular-nums text-slate-900">{value}</p>
        ...
        <div>
                    ...
                    <div className="grid items-center gap-12 lg:grid-cols-12">
                        <div className="lg:col-span-7">
                            ...
                            <h1 className="mt-3 text-4xl font-bold leading-tight tracking-tight text-slate-900 sm:text-5xl">
                                ...
                                <span className="text-indigo-700">why</span>?
                            </h1>
                        ...
                        <div className="lg:col-span-5">
                            <div className="panel shadow-panel">
                                <div className="panel-header">
                                    ...
                                    <span className="text-[11px] text-slate-400">v2.0.0</span>
                                </div>
                        ...
                        {STEPS.map((step, i) => (
                            <div key={step.n} className="relative panel shadow-panel">
                                <div className="panel-body">
                                    <span className="font-mono text-xs font-medium text-indigo-700">{step.n}</span>
                                ...
                                {i < STEPS.length - 1 && (
                                    <span
                                        aria-hidden="true"
                                        className="absolute -right-3 top-1/2 hidden h-6 w-6 -translate-y-1/2 items-center justify-center rounded-full border border-slate-200 bg-white text-slate-400 md:flex"
                                    >
            ...
            <section className="border-b border-slate-200 bg-white">
                <PageContainer size="xl" className="py-16">
                    ...
                    <div className="mt-6 grid divide-y divide-slate-100 rounded-xl border border-slate-200 bg-white sm:grid-cols-2 sm:divide-x lg:grid-cols-4 lg:divide-y-0">
                        <Stat
                            label="Macro-F1"
            ...
            <section className="bg-slate-50">
                <PageContainer size="xl" className="py-16">
                    ...
                    <div className="mt-10 flex flex-wrap items-center justify-between gap-4 rounded-xl border border-slate-200 bg-white px-6 py-6">
                        <div>
                            <h2 className="text-lg font-semibold text-slate-900">See it on a real profile</h2>
